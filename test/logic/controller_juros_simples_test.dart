...
void main() {
  ...
  group(
    ...
    () {
      test(
        "Teste do reset de preenchimento de campos",
        () {
      ...
      test(
        ...
        () {
          ...
          expect(
              jurosSimples.resultjS, "Apenas 3 campos devem ser preenchidos.");
          ...
          expect(jurosSimples.resultjS,
              "É necessário que ao menos 3 campos estejam preenchidos.");
      ...
      group(
        ...
        () {
          ...
          test(
            "Testando lista de respostas da calculadora de Juros Simples",
            () {
              jurosSimples.c.text = "8";
              jurosSimples.i.text = "5";
              jurosSimples.t.text = "4";

              jurosSimples.calcular();

              expect(jurosSimples.responseList(), [
          ...
          test(
            "Testando lista de controllers da calculadora de Juros Simples",
            () {
              ...
              expect(listController, jurosSimples.controllerList());
            },
          );

          test(
            "Testando lista de labels da calculadora de Juros Simples",
            () {
              List<String> listLabels = ["Capital:", "Taxa:", "Meses:", "Juros:"];

              expect(listLabels, jurosSimples.labelList());
            },
          );
        },
      );
