class ExponentsStrings {
  static const String exponentsText1 =
      ...
      "Como é possível notar, o número 2 está sendo multiplicado por ele mesmo na mesma "
      "quantidade de vezes que o expoente. No caso 3! Agora que já entendemos, vamos tentar "
      "aplicar a nossa explicação.";

  static const String exponentsText2 =
      "Seguindo a regra de parêntesis, vamos primeiro resolver o conteúdo dentro dos parêntesis.";

  static const String exponentsText3 =
      "Agora que temos o resultado dentro dos parêntesis, podemos seguir com a resolução do expoente.";

  static const String exponentsText4 =
