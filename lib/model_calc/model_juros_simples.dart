...
class ModelJurosSimples {
  ...
  void verificarCampos(){
    if((c.text.isNotEmpty) && (i.text.isNotEmpty) && (t.text.isNotEmpty) && (j.text.isNotEmpty)) {
        resultjS = "Somente é possível fazer o cálculo com 3 campos preenchidos. Tire um dos valores para calcular!";
        resultjS_1 = "";
        resultjS_2 = "";
      } else if ((c.text.isEmpty) && (i.text.isEmpty) && (t.text.isEmpty) && (j.text.isEmpty)) {
        resultjS = "Preencha ao menos 3 dos 4 campos disponíveis para efetuar o cálculo.";
        resultjS_1 = "";
        resultjS_2 = "";
      } else if (((j.text.isEmpty) && (c.text.isEmpty)) || ((i.text.isEmpty) && (t.text.isEmpty)) ||
  ...
  void jurosSimples (){
      ...
      j1 = j.text;
        ...
        if ((c.text.isNotEmpty) && (i.text.isNotEmpty) && (t.text.isNotEmpty)) {
          ...
          resultjS = "A fórmula para encontrar o tempo necessário para o investimento é:" "\n"
              "t = (J * 100) / (C * i)" "\n";
