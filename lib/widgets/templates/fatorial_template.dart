          ...
          children: [
            ContentList(
              stringsAndAssets: [
                ...
                StringsAndAssetsModel(title: CoreStringsFatorial.text3_Fatorial, fontSize: 20, color: Colors.red, fontWeight: FontWeight.bold),
                ...
                StringsAndAssetsModel(title: CoreStringsFatorial.text8_Fatorial, fontSize: 20, fontWeight: FontWeight.bold, textAlign: TextAlign.center),
                ...
                StringsAndAssetsModel(title: CoreStringsFatorial.text11_Fatorial, fontSize: 20, fontWeight: FontWeight.bold, textAlign: TextAlign.center),
                ...
                StringsAndAssetsModel(title: CoreStringsFatorial.text14_Fatorial, textAlign: TextAlign.center, fontSize: 20, fontWeight: FontWeight.bold),
                ...
                StringsAndAssetsModel(title: CoreStringsFatorial.text18_Fatorial, fontSize: 20, fontWeight: FontWeight.bold, textAlign: TextAlign.center),
